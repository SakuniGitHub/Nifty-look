                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <img class="card-img" src="<?php echo e(asset('storage/' . $rental->product_image)); ?>"
                                                alt="<?php echo e($rental->product_name); ?>" style="width:100%; height:350px;" />
                                            <div class="p_icon" style="width:100%">
                                                <a href="#">
                                                    <i class="ti-eye"></i>
                                                </a>
                                                <a href="javascript:void(0);"
                                                    onclick="addToWishlist(<?php echo e($rental->id); ?>)">
                                                    <i class="ti-heart"></i>
                                                </a>
                                                <form action="<?php echo e(route('rental-cart.add', $rental->id)); ?>" method="POST"
                                                    style="display: inline;" class="ajax-form">
                                                    <?php echo csrf_field(); ?>
                                                    <a href="#" class="add-to-cart"
                                                        data-product-id="<?php echo e($rental->id); ?>">
                                        ...
                                        <div class="product-btm">
                                            <a href="#" class="d-block">
                                                <h4><?php echo e($rental->product_name); ?></h4>
                                            </a>
                                            <div class="mt-3">
                                                <span class="mr-4">Rs:
                                                    <?php echo e(number_format($rental->rent_price, 2)); ?>
...
<?php /**PATH C:\xampp\htdocs\nifty_look\resources\views/rental.blade.php ENDPATH**/ ?>
                        ...
                        <div class="sticky-content">
                            ...
                            <div class="checkout__totals mb-4">
                                ...
                                <table class="checkout-cart-items table table-bordered mb-3">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($item->product_name); ?> x <?php echo e($item->quantity); ?></td>
                                                <td class="text-end">Rs :
                                                    <?php echo e(number_format($item->sell_price * $item->quantity, 2)); ?>
                                ...
                                <table class="checkout-cart-items table table-bordered mb-3">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $rentCartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rentItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($rentItem->product_name); ?> x <?php echo e($rentItem->quantity); ?></td>
                                                <td class="text-end">Rs :
                                                    <?php echo e(number_format($rentItem->rent_price * $rentItem->quantity, 2)); ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-end">Rs : <span
                                                    id="sub-total-price"><?php echo e(number_format($buyPrice + $rentPrice, 2)); ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>SHIPPING</th>
                                        ...
                                        <?php if($highestDiscount > 0): ?>
                                            <tr>
                                                <th>DISCOUNT (<?php echo e($highestDiscount); ?>%)</th>
                                                <td class="text-end">- Rs : <span
                                                        id="discount-amount"><?php echo e(number_format(($highestDiscount)*($buyPrice + $rentPrice)/100, 2)); ?></span>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                        <tr>
                                            <th>TOTAL</th>
                                            <td class="text-end">Rs : <span
                                                    id="total-price"><?php echo e(number_format((100-$highestDiscount)*($buyPrice + $rentPrice)/100, 2)); ?></span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <input type="hidden" name="total_price" id="total-price-input"
                                    value="<?php echo e(number_format($buyPrice + $rentPrice, 2)); ?>" />
                            </div>
...
<script>
    document.getElementById('order-place-btn').addEventListener('click', function(e) {
        ...
        fetch('<?php echo e(route('place-order')); ?>', {
                method: 'POST',
                body: formData,
                headers: {
...
<?php /**PATH C:\xampp\htdocs\nifty_look\resources\views/checkout.blade.php ENDPATH**/ ?>
...
<div class="wrapper">
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="register-link">
            <p>Don't have an account? <br> <a href="<?php echo e(route('register')); ?>">Register</a></p>
        </div>
    </form>
</div>
...
<?php /**PATH G:\Projects\freind projects\Nifty-look\resources\views/auth/login.blade.php ENDPATH**/ ?>